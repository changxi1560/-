...
#define PWM_LEFT 11   // 用于左轮电机的PWM输出，调节电机速度
#define DIR_L1 6      // 6引脚用于左轮电机的转动方向控制（1正转，0反转）
#define PWM_RIGHT 12  // 用于右轮电机的PWM输出，调节电机速度
#define DIR_R1 7      // 7引脚用于右轮电机的转动方向控制（1正转，0反转）
...
#define SERVO_CNT 2
#define SERVO_1 9  // 底部舵机 可用范围：1500-2500 增大时向后放倒，1500初始竖直位置，2500水平位置
#define SERVO_2 10   // 顶部舵机 可用范围：1000-1500 增大时夹紧，1000初始位置，1500夹紧位置
